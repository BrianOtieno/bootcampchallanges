...
from forms import RegistrationForm, LoginForm, PostCommentForm
from werkzeug import generate_password_hash, check_password_hash


app = Flask(__name__, static_url_path='')

app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:5ure5t@re!@localhost/andelalevelup'
db.init_app(app)
...
def register():
    ...
    if request.method == "POST":
        if form.validate() == False:
            ...
            newaccount = User(form.firstname.data, form.lastname.data, form.phonenumber.data, form.email.data, form.password.data)
